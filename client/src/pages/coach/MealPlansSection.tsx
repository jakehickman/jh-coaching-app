                    ...
                    <div className="flex items-center justify-between mt-3 pt-2 border-t border-border/30">
                      ...
                      {(meal.items ?? []).some((it: any) => it.food && parseFloat(it.grams) > 0) && (
                        <div className="flex items-center gap-3">
                          <span className="text-[11px] font-semibold text-primary/70">{mealMacros[i].calories} kcal</span>
                          <span className="text-[11px] text-muted-foreground">P{mealMacros[i].protein} C{mealMacros[i].carbs} F{mealMacros[i].fat}</span>
                        </div>
                      )}
                    </div>
                  </Card>
