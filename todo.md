...
## Weekly Review Dashboard Redesign (Apr 2026)
- [ ] Add weeklyReview tRPC procedure to aggregate all metrics per 7-day period with deltas
- [ ] Build WeeklyReviewTab component with Option 1 (Weekly Cards) and Option 2 (Expandable Rows) toggle
- [ ] Replace existing Overview tab content with the new Weekly Review
- [ ] Wire delta calculations and auto-generated summary line
