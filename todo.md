...
## MMCR (Mind Muscle Connection Rating)
- [x] MMCR: Add mmcr field to WorkoutSet type in drizzle/schema.ts and router Zod schema
- [x] MMCR: Add mmcr state and handler to WorkoutLogTab in TrainingTab.tsx
- [x] MMCR: Render 5-dot rating UI after first set is ticked (client training log)
